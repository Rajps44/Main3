...
STREAM_API = (environ.get('STREAM_API', '0aba084730c9cbc312fa7ec89436b46641586185'))
STREAMHTO = (environ.get('STREAMHTO', ''))

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6174868004 6508598835').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002233212878').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '-1002213457968').split()]
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/netfilixmo_ch')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : Raj')
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002213457968'))
